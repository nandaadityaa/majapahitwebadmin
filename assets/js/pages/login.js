    ...
    return {
        init: function() {
            ...
            $('#form-reminder').validate({
                ...
                messages: {
                    'reminder_email': 'Silahkan masukkan email akun anda',
                    'verifikasi_email': 'Silahkan masukkan email akun anda'
                }
            });
            ...
            $('#form-register').validate({
                ...
                messages: {
                    ...
                    'register_email': 'Silahkan masukkan email akun anda',
                    'verifikasi_email': 'Silahkan masukkan email akun anda',
                    'register_password': {
