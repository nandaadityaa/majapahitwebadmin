    ...
    <div class="block full">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="pt-table-based"> 
                <?php echo form_open_multipart('user/user/update/'.$data[0]['kode_user'],'class="form-horizontal" id="form-validation" ');?>
                    <?php echo view_errors();?> 
                    <div class="row">
                        <div class="col-md-3">
                            <div class='form-group' style="padding-left: 5px;padding-right: 5px">
                            <?php echo form_text('Kode User','kode_user',(isset($data[0]['kode_user']))?$data[0]['kode_user']:'','required="required" class="form-control" readonly placeholder="KAR-004"');?>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class='form-group' style="padding-left: 5px;padding-right: 5px">
                            <?php echo form_text('Nama Customer','nama_cust',(isset($data[0]['nama_cust']))?$data[0]['nama_cust']:'','required="required"class="form-control" placeholder="Nama Customer"');?>
                            </div>
                        </div> 
                        <div class="col-md-3">
                            <div class='form-group' style="padding-left: 5px;padding-right: 5px">
                        ...
                        <div class="col-md-3">
                            <div class='form-group' style="padding-left: 5px;padding-right: 5px;">
                            <?php echo form_text('No Tlp','no_tlp',(isset($data[0]['no_tlp']))?$data[0]['no_tlp']:'','required="required"class="form-control" placeholder="No Tlp"');?>
                            </div>
                        </div>
                    </div>
