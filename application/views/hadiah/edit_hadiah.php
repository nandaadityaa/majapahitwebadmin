    ...
    <div class="block full"> 
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="pt-table-based"> 
                <?php echo form_open_multipart('hadiah/hadiah/update/'.$data[0]['kode_hadiah'],'class="form-horizontal" id="form-validation" ');?>
                    <?php echo view_errors();?>
                    <div class="row">
                        <div class="col-md-3">
                            <div class='form-group' style="padding-left: 5px;padding-right: 5px">
                            <?php echo form_text('Kode hadiah','kode_hadiah',(isset($data[0]['kode_hadiah']))?$data[0]['kode_hadiah']:'','required="required" class="form-control" readonly placeholder="KAR-004"');?>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class='form-group' style="padding-left: 5px;padding-right: 5px">
                            <?php echo form_text('Nama Hadiah','nama_hadiah',(isset($data[0]['nama_hadiah']))?$data[0]['nama_hadiah']:'','required="required"class="form-control" placeholder="Nama"');?>
                            </div>
                        </div> 
                        <div class="col-md-3">
                            <div class='form-group' style="padding-left: 5px;padding-right: 5px">
                            <?php echo form_text('Point','point',(isset($data[0]['point']))?$data[0]['point']:'','required="required"class="form-control" placeholder="Point"');?>
                            </div>
                        </div>
                    </div>
